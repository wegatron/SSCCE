...
static const char qt_meta_stringdata_OSGWidget[] = {
    "OSGWidget\0"
};
...
const QMetaObjectExtraData OSGWidget::staticMetaObjectExtraData = {
    0,  qt_static_metacall 
};

const QMetaObject OSGWidget::staticMetaObject = {
    { &QGLWidget::staticMetaObject, qt_meta_stringdata_OSGWidget,
      qt_meta_data_OSGWidget, &staticMetaObjectExtraData }
};

#ifdef Q_NO_DATA_RELOCATION
const QMetaObject &OSGWidget::getStaticMetaObject() { return staticMetaObject; }
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_OSGWidget))
